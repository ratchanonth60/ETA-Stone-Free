...
! function () {
    ...
    var a, n, o, r, d, h, l, c, u, _, f, m, w, g, i, b, v, M = (a = jQuery, n = moment, l = {
        DATA_TOGGLE: '[data-bs-toggle="' + (r = o = "datetimepicker") + '"]'
    }, c = {
        INPUT: o + "-input"
    }, u = {
        CHANGE: "change" + (d = "." + r),
    ...
    E = jQuery, t = E.fn[M.NAME], p = ["top", "bottom", "auto"], C = ["left", "right", "auto"], T = ["default", "top", "bottom"], x = function (d) {
        ...
        return i._init = function () {
            var t;
            this._element.hasClass("input-group") && (0 === (t = this._element.find(".datepickerbutton")).length ? this.component = this._element.find('[data-bs-toggle="datetimepicker"]') : this.component = t)
        ...
        var t = E(this),
            e = I(t),
            i = e.data(M.DATA_KEY);
        0 !== e.length && (i._options.allowInputToggle && t.is('input[data-bs-toggle="datetimepicker"]') || x._jQueryInterface.call(e, "toggle"))
