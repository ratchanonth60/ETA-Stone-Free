            ...
            path(
                ...
                login_forbidden(
                    auth_views.PasswordResetView.as_view(
                        ...
                        template_name="eta/registration/password_reset_form.html",
                    ),
                    "eta/403.html",
                ),
                name="password-reset",
            ...
            path(
                ...
                login_forbidden(
                    auth_views.PasswordResetDoneView.as_view(
                        template_name="eta/registration/password_reset_done.html"
                    ),
                    "eta/403.html",
                ),
            ...
            path(
                ...
                login_forbidden(
                    auth_views.PasswordResetConfirmView.as_view(
                        ...
                        template_name="eta/registration/password_reset_confirm.html",
                    ),
                    "eta/403.html",
                ),
            ...
            path(
                ...
                login_forbidden(
                    auth_views.PasswordResetCompleteView.as_view(
                        template_name="eta/registration/password_reset_complete.html"
                    ),
                    "eta/403.html",
                ),
