...
from ecommerce.apps.communication.models import CommunicationEventType
...
class OrderCreator(object):
    ...
    def create_discount_model(self, order, discount):
        ...
        if voucher := discount.get("voucher", None):
