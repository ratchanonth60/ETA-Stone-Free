...
class Structured(Base):
    ...
    def parent_pricing_policy(self, product, children_stock):
        raise NotImplementedError(
            "A structured strategy class must define a parent_pricing_policy method"
        )
    ...
    def availability_policy(self, product, stockrecord):
        ...
        """
        raise NotImplementedError(
            "A structured strategy class must define an 'availability_policy' method"
        )

    def parent_availability_policy(self, product, children_stock):
        raise NotImplementedError(
            "A structured strategy class must define a 'parent_availability_policy' method"
        )
...
class UK(UseFirstStockRecord, StockRequired, FixedRateTax, Structured):
    ...
    rate = D("0.20")  # The standard VAT rate is 20%


class TH(UseFirstStockRecord, StockRequired, DeferredTax, Structured):
    """
    ...
    rate = D("0.07")  # The standard VAT rate is 7%
