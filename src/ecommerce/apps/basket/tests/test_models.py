...
from ecommerce.apps.catalogue.models import Category, Option
...
class TestBasketLine(TestCase):
    ...
    def test_description(self):
        line = self._extracted_from_test_description_with_attributes()
    ...
    # TODO Rename this here and in `test_description` and `test_description_with_attributes`
    def _extracted_from_test_description_with_attributes(self):
        basket = BasketFactory()
        product = ProductFactory(title="A product")
        basket.add_product(product)
        return basket.lines.first()
