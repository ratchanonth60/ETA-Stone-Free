...
from ecommerce.apps.offer.models import ConditionalOffer, Range


class OfferListView(ListView):
    model = ConditionalOffer
    context_object_name = "offers"
    template_name = "eta/offer/list.html"
...
class OfferDetailView(ListView):
    ...
    template_name = "eta/offer/detail.html"
    ...
    def get(self, request, *args, **kwargs):
        ...
        except ConditionalOffer.DoesNotExist as e:
...
class RangeDetailView(ListView):
    template_name = "eta/offer/range.html"
    context_object_name = "products"
