...
class OfferReportHTMLFormatter(ReportHTMLFormatter):
    filename_template = "eta/dashboard/reports/partials/offer_report.html"
    ...
    def get_queryset(self):
        ...
        return (
            ...
            .annotate(
                ...
                # Find the name of the attached offer if it exists, otherwise the
                # offer_name on a matching OrderDiscount
