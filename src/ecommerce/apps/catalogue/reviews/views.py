...
class CreateProductReview(CreateView):
    template_name = "eta/catalogue/reviews/review_form.html"
    model = ProductReview
...
class ProductReviewDetail(DetailView):
    template_name = "eta/catalogue/reviews/review_detail.html"
...
class ProductReviewList(ListView):
    ...
    """
    template_name = 'eta/catalogue/reviews/review_list.html'
