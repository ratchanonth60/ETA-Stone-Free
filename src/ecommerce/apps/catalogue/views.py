...
from ecommerce.apps.catalogue.search_handlers import get_product_search_handler_class
from ecommerce.apps.customer.forms import ProductAlertForm
...
class ProductDetailView(DetailView):
    ...
    def get_object(self, queryset=None):
        ...
        return self.object if hasattr(self, "object") else super().get_object(queryset)
    ...
    def get_template_names(self):
        ...
        return [
            f"eta/{self.template_folder}/detail-for-upc-{self.object.upc}.html",
            f"eta/{self.template_folder}/detail-for-class-{self.object.get_product_class().slug}.html",
            f"eta/{self.template_folder}/detail.html",
        ]
...
class CatalogueView(TemplateView):
    ...
    template_name = "eta/catalogue/browse.html"
...
class ProductCategoryView(TemplateView):
    ...
    context_object_name = "products"
    template_name = "eta/catalogue/category.html"
    enforce_paths = True
