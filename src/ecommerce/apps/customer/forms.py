...
from oscar.core.loading import get_model, get_profile_class
...
class PasswordResetForm(auth_forms.PasswordResetForm):
    ...
    def send_password_reset_email(self, site, user, request=None):
        ...
        ).send_password_reset_email_for_user(user, extra_context)
...
if Profile:  # noqa (too complex (12))
    ...
    class UserAndProfileForm(forms.ModelForm):
        def __init__(self, user, *args, **kwargs):
            ...
            core_field_names = {f.name for f in User._meta.fields}
            user_field_names = ["email"]
            user_field_names.extend(
                field_name
