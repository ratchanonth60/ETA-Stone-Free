...
from ecommerce.apps.wishlists.models import WishList
from ecommerce.test.factories import WishListFactory, create_product
...
class TestWishListRemoveProduct(WishListTestMixin, WebTestCase):
    ...
    def test_remove_wishlist_line(self):
        ...
        # Test WishList doesnt contain line and return 404
        self.assertEqual(self.get(delete_wishlist_line_url, expect_errors=True).status_code, 200)
    ...
    def test_remove_wishlist_product(self):
        ...
        # Test WishList doesnt contain line and return 404
        self.assertEqual(self.get(delete_wishlist_product_url, expect_errors=True).status_code, 200)
