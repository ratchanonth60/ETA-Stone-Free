...
from ecommerce.apps.wishlists.forms import WishListForm
from ecommerce.apps.wishlists.formsets import LineFormset, WishListSharedEmailFormset
from ecommerce.apps.wishlists.models import Line, WishList


class WishListListView(PageTitleMixin, ListView):
    context_object_name = active_tab = "wishlists"
    template_name = "eta/customer/wishlists/wishlists_list.html"
...
class WishListDetailView(PageTitleMixin, FormView):
    ...
    template_name = "eta/customer/wishlists/wishlists_detail.html"
...
class WishListCreateView(WishListCreateUpdateViewMixin, CreateView):
    ...
    model = WishList
    template_name = "eta/customer/wishlists/wishlists_form.html"
    active_tab = "wishlists"
...
class WishListDeleteView(PageTitleMixin, DeleteView):
    model = WishList
    template_name = "eta/customer/wishlists/wishlists_delete.html"
    active_tab = "wishlists"
...
class WishListAddProduct(View):
    ...
    def get_or_create_wishlist(self, request, *args, **kwargs):
        ...
        elif wishlists := request.user.wishlists.all()[:1]:
            wishlist = wishlists[0]
...
class WishListRemoveProduct(LineMixin, PageTitleMixin, DeleteView):
    template_name = "eta/customer/wishlists/wishlists_delete_product.html"
    active_tab = "wishlists"
