...
class AlertsDispatcher:
    ...
    def notify_user_about_product_alert(self, user, context):
        subj_tpl = loader.get_template("eta/customer/alerts/message_subject.html")
        message_tpl = loader.get_template("eta/customer/alerts/message.html")
