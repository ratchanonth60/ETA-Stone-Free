...
class CheckoutSessionData(object):
    ...
    def ship_to_new_address(self, address_fields):
        ...
        if phone_number := address_fields.get("phone_number"):
    ...
    def pay_by_saved_card(self, card_id):
        """
        Record the use of a saved card for this checkout session
        """
        self._set('payment', 'saved_card_id', card_id)
