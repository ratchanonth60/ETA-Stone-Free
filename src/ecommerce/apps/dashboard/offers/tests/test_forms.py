...
from ecommerce.apps.dashboard.offers import forms
from ecommerce.apps.offer.models import Benefit, Range
from ecommerce.test.factories import create_product
from ecommerce.test.model_tests_app.models import (
    CustomBenefitModel,
