...
from ecommerce.forms import widgets
...
class RestrictionsForm(forms.ModelForm):
    ...
    def save(self, *args, **kwargs):
        ...
        if instance.id:
            self._update_offer_combinations(instance)
            self._update_combined_offers(instance)
        return instance

    def _update_offer_combinations(self, instance):
    ...
    def _update_combined_offers(self, instance):
...
class ConditionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(custom_conditions) > 0:
            ...
            if condition := kwargs.get('instance'):
...
class BenefitForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(custom_benefits) > 0:
            ...
            if benefit := kwargs.get('instance'):
