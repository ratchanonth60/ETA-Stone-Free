...
from ecommerce.forms.widgets import DateTimePickerInput, ImageInput
...
ProductSelect = get_class(
    "dashboard.catalogue.widgets", "ProductSelect", "ecommerce.apps"
)
...
class ProductForm(SEOFormMixin, forms.ModelForm):
    ...
    def add_attribute_fields(self, product_class, is_parent=False):
        ...
        """
        for attribute in product_class.attributes.all():
            if field := self.get_attribute_field(attribute):
...
class ProductClassForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        RelatedMultipleFieldWidgetWrapper.template_name = (
            "eta/dashboard/widgets/related_multiple_widget_wrapper.html"
        )
