...
DashboardTable = get_class("dashboard.tables", "DashboardTable", "ecommerce.apps")
...
class ProductTable(DashboardTable):
    title = TemplateColumn(
        ...
        template_name="eta/dashboard/catalogue/product_row_title.html",
        order_by="title",
        accessor=A("title"),
    )
    image = TemplateColumn(
        verbose_name=_("Image"),
        template_name="eta/dashboard/catalogue/product_row_image.html",
        orderable=False,
    )
    ...
    variants = TemplateColumn(
        ...
        template_name="eta/dashboard/catalogue/product_row_variants.html",
        orderable=False,
    )
    stock_records = TemplateColumn(
        verbose_name=_("Stock records"),
        template_name="eta/dashboard/catalogue/product_row_stockrecords.html",
        orderable=False,
    )
    actions = TemplateColumn(
        verbose_name=_("Actions"),
        template_name="eta/dashboard/catalogue/product_row_actions.html",
        orderable=False,
    )
...
class CategoryTable(DashboardTable):
    ...
    actions = TemplateColumn(
        template_name="eta/dashboard/catalogue/category_row_actions.html",
        orderable=False,
    )
...
class AttributeOptionGroupTable(DashboardTable):
    name = TemplateColumn(
        verbose_name=_("Name"),
        template_name="eta/dashboard/catalogue/attribute_option_group_row_name.html",
        order_by="name",
    )
    option_summary = TemplateColumn(
        verbose_name=_("Option summary"),
        template_name="eta/dashboard/catalogue/attribute_option_group_row_option_summary.html",
        orderable=False,
    )
    actions = TemplateColumn(
        verbose_name=_("Actions"),
        template_name="eta/dashboard/catalogue/attribute_option_group_row_actions.html",
        orderable=False,
    )
...
class OptionTable(DashboardTable):
    name = TemplateColumn(
        verbose_name=_("Name"),
        template_name="eta/dashboard/catalogue/option_row_name.html",
        order_by="name",
    )
    actions = TemplateColumn(
        verbose_name=_("Actions"),
        template_name="eta/dashboard/catalogue/option_row_actions.html",
        orderable=False,
    )
