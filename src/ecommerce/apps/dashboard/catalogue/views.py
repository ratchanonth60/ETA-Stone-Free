...
from ecommerce.apps.dashboard.catalogue.forms import (
...
from ecommerce.apps.dashboard.catalogue.formsets import (
...
from ecommerce.apps.dashboard.catalogue.mixins import PartnerProductFilterMixin
from ecommerce.apps.dashboard.catalogue.tables import (
    AttributeOptionGroupTable,
    CategoryTable,
    OptionTable,
    ProductTable,
)
from ecommerce.apps.dashboard.views import (
    PopUpWindowCreateMixin,
    PopUpWindowDeleteMixin,
    PopUpWindowUpdateMixin,
)
from ecommerce.apps.partner.models import StockAlert
...
class ProductListView(PartnerProductFilterMixin, SingleTableView):
    ...
    template_name = "eta/dashboard/catalogue/product_list.html"
...
class ProductCreateUpdateView(PartnerProductFilterMixin, generic.UpdateView):
    ...
    template_name = "eta/dashboard/catalogue/product_update.html"
    model = Product
    ...
    def get_page_title(self):
        if self.creating:
            return (
                _("Create new %(product_class)s product")
                % {"product_class": self.product_class.name}
                if self.parent is None
                else _("Create new variant of %(parent_product)s")
    ...
    def get_success_url(self):
        ...
        msg = render_to_string(
            "eta/dashboard/catalogue/messages/product_saved.html",
            {
                "product": self.object,
...
class ProductDeleteView(PartnerProductFilterMixin, generic.DeleteView):
    ...
    template_name = "eta/dashboard/catalogue/product_delete.html"
    model = Product
    context_object_name = "product"
...
class StockAlertListView(generic.ListView):
    template_name = "eta/dashboard/catalogue/stockalert_list.html"
    model = StockAlert
...
class CategoryListView(SingleTableView):
    template_name = "eta/dashboard/catalogue/category_list.html"
...
class CategoryCreateView(CategoryListMixin, generic.CreateView):
    template_name = "eta/dashboard/catalogue/category_form.html"
    model = Category
...
class CategoryDeleteView(CategoryListMixin, generic.DeleteView):
    template_name = "eta/dashboard/catalogue/category_delete.html"
    model = Category
...
class ProductClassCreateUpdateView(generic.UpdateView):
    template_name = "eta/dashboard/catalogue/product_class_form.html"
    model = ProductClass
...
class ProductClassListView(generic.ListView):
    template_name = "eta/dashboard/catalogue/product_class_list.html"
...
class ProductClassDeleteView(generic.DeleteView):
    template_name = "eta/dashboard/catalogue/product_class_delete.html"
    model = ProductClass
    form_class = ProductClassForm
...
class AttributeOptionGroupCreateUpdateView(generic.UpdateView):
    ...
    def process_all_forms(self, form):
        ...
        if form.is_valid() and attribute_option_formset.is_valid():
...
class AttributeOptionGroupListView(SingleTableView):
    template_name = "eta/dashboard/catalogue/attribute_option_group_list.html"
    model = AttributeOptionGroup
...
class OptionListView(SingleTableView):
    template_name = "eta/dashboard/catalogue/option_list.html"
    model = Option
