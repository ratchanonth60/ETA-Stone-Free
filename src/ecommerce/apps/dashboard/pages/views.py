...
PageSearchForm, PageUpdateForm = get_classes(
    "dashboard.pages.forms", ("PageSearchForm", "PageUpdateForm"), "ecommerce.apps"
)
...
class PageListView(ListView):
    ...
    template_name = "eta/dashboard/pages/index.html"
    model = FlatPage
...
class PageCreateUpdateMixin(object):
    template_name = "eta/dashboard/pages/update.html"
    model = FlatPage
    ...
    def get_success_url(self):
        msg = render_to_string(
            "eta/dashboard/pages/messages/saved.html", {"page": self.object}
        )
...
class PageDeleteView(generic.DeleteView):
    template_name = "eta/dashboard/pages/delete.html"
    model = FlatPage
