...
VoucherForm = get_class("dashboard.vouchers.forms", "VoucherForm", "ecommerce.apps")
VoucherSetForm = get_class(
    "dashboard.vouchers.forms", "VoucherSetForm", "ecommerce.apps"
)
VoucherSetSearchForm = get_class(
    "dashboard.vouchers.forms", "VoucherSetSearchForm", "ecommerce.apps"
)
VoucherSearchForm = get_class(
    "dashboard.vouchers.forms", "VoucherSearchForm", "ecommerce.apps"
)
...
class VoucherListView(generic.ListView):
    ...
    template_name = "eta/dashboard/vouchers/voucher_list.html"
...
class VoucherCreateView(generic.CreateView):
    model = Voucher
    template_name = "eta/dashboard/vouchers/voucher_form.html"
...
class VoucherStatsView(generic.DetailView):
    model = Voucher
    template_name = "eta/dashboard/vouchers/voucher_detail.html"
...
class VoucherDeleteView(generic.DeleteView):
    model = Voucher
    template_name = "eta/dashboard/vouchers/voucher_delete.html"
    context_object_name = "voucher"
...
class VoucherSetCreateView(generic.CreateView):
    model = VoucherSet
    template_name = "eta/dashboard/vouchers/voucher_set_form.html"
...
class VoucherSetDetailView(generic.ListView):
    ...
    model = Voucher
    context_object_name = "vouchers"
    template_name = "eta/dashboard/vouchers/voucher_set_detail.html"
...
class VoucherSetListView(generic.ListView):
    ...
    template_name = "eta/dashboard/vouchers/voucher_set_list.html"
    paginate_by = settings.OSCAR_DASHBOARD_ITEMS_PER_PAGE
...
class VoucherSetDownloadView(generic.DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        response["Content-Disposition"] = (
            f'attachment; filename="{slugify(voucher_set.name)}.csv"'
        )
...
class VoucherSetDeleteView(generic.DeleteView):
    model = VoucherSet
    template_name = "eta/dashboard/vouchers/voucher_set_delete.html"
    context_object_name = "voucher_set"
