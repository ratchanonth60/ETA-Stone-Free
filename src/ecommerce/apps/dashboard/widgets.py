...
class RelatedFieldWidgetWrapper(Widget):
    ...
    template_name = "eta/dashboard/widgets/related_widget_wrapper.html"
    ...
    def get_related_url(self, info, action, *args):
        ...
        return reverse(
            f"dashboard:{app_label}-{model_object_name}-{action}", args=args
        )
...
class RelatedMultipleFieldWidgetWrapper(RelatedFieldWidgetWrapper):
    template_name = "eta/dashboard/widgets/related_multiple_widget_wrapper.html"
