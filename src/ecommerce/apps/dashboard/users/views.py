...
from ecommerce.apps.customer.forms import PasswordResetForm
from ecommerce.apps.customer.models import ProductAlert
from ecommerce.apps.dashboard.users.tables import UserTable

from .forms import ProductAlertSearchForm, ProductAlertUpdateForm, UserSearchForm

User = get_user_model()


class IndexView(BulkEditMixin, FormMixin, SingleTableView):
    template_name = "eta/dashboard/users/index.html"
    model = User
    actions = (
        "make_active",
        "make_inactive",
...
class UserDetailView(DetailView):
    template_name = "eta/dashboard/users/detail.html"
    model = User
...
class ProductAlertListView(ListView):
    ...
    template_name = "eta/dashboard/users/alerts/list.html"
...
class ProductAlertUpdateView(UpdateView):
    template_name = "eta/dashboard/users/alerts/update.html"
    model = ProductAlert
...
class ProductAlertDeleteView(DeleteView):
    model = ProductAlert
    template_name = "eta/dashboard/users/alerts/delete.html"
    context_object_name = "alert"
