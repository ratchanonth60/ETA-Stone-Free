...
class CommunicationEventTypeForm(forms.ModelForm):
    ...
    def clean_email_subject_template(self):
        return self._extracted_from_clean_email_body_html_template(
    ...
    def _extracted_from_clean_email_body_html_template(self, arg0):
        subject = self.cleaned_data[arg0]
    ...
    def clean_preview_order_number(self):
        ...
        try:
            ...
            raise forms.ValidationError(
                _("No order found with this number")
            ) from e
        return number
