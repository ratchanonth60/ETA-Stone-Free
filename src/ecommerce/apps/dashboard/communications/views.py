...
CommunicationEventTypeForm = get_class(
    "dashboard.communications.forms", "CommunicationEventTypeForm", "ecommerce.apps"
)


class ListView(generic.ListView):
    model = CommunicationEventType
    template_name = "eta/dashboard/comms/list.html"
...
class UpdateView(generic.UpdateView):
    ...
    template_name = "eta/dashboard/comms/detail.html"
