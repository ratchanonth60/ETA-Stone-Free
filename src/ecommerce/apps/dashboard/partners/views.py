...
class PartnerListView(generic.ListView):
    ...
    template_name = "eta/dashboard/partners/partner_list.html"
...
class PartnerCreateView(generic.CreateView):
    model = Partner
    template_name = "eta/dashboard/partners/partner_form.html"
...
class PartnerManageView(generic.UpdateView):
    ...
    template_name = "eta/dashboard/partners/partner_manage.html"
...
class PartnerDeleteView(generic.DeleteView):
    model = Partner
    template_name = "eta/dashboard/partners/partner_delete.html"
...
class PartnerUserCreateView(generic.CreateView):
    model = User
    template_name = "eta/dashboard/partners/partner_user_form.html"
...
class PartnerUserSelectView(generic.ListView):
    template_name = "eta/dashboard/partners/partner_user_select.html"
    ...
    def get(self, request, *args, **kwargs):
        data = request.GET if "email" in request.GET else None
    ...
    def post(self, request, user_pk, partner_pk):
        ...
        if self.unlink_user(user, partner):
            msg = render_to_string(
                "eta/dashboard/partners/messages/user_unlinked.html",
                {
                    "user_name": name,
