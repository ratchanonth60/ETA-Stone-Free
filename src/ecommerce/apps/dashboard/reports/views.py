...
GeneratorRepository = get_class(
    "dashboard.reports.utils", "GeneratorRepository", "ecommerce.apps"
)


class IndexView(ListView):
    template_name = "eta/dashboard/reports/index.html"
            ...
            if form.is_valid():
                ...
                if not generator.is_available_to(request.user):
                    return HttpResponseForbidden(
                        _("You do not have access to", " this report")  # Add a comma between the strings
                    )
                ...
                if form.cleaned_data["download"]:
                    ...
                    return self._extracted_from_get(generator, form)
        else:
            form = self.report_form_class()
        return TemplateResponse(request, self.template_name, {"form": form})

    # Rename this method here and in `get`
    def _extracted_from_get(self, generator, form):
