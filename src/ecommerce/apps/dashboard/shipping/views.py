...
WeightBandForm, WeightBasedForm = get_classes(
    "dashboard.shipping.forms", ["WeightBandForm", "WeightBasedForm"], "ecommerce.apps"
)
...
class WeightBasedListView(generic.ListView):
    model = WeightBased
    template_name = "eta/dashboard/shipping/weight_based_list.html"
...
class WeightBasedCreateView(generic.CreateView):
    ...
    template_name = "eta/dashboard/shipping/weight_based_form.html"

    def get_success_url(self):
        msg = render_to_string(
            "eta/dashboard/shipping/messages/method_created.html",
            {"method": self.object},
        )
...
class WeightBasedDetailView(generic.CreateView):
    ...
    template_name = "eta/dashboard/shipping/weight_based_detail.html"
    ...
    def get_success_url(self):
        msg = render_to_string(
            "eta/dashboard/shipping/messages/band_created.html", {"band": self.object}
        )
        messages.success(self.request, msg, extra_tags="safe noicon")
        return reverse(
...
class WeightBasedUpdateView(generic.UpdateView):
    ...
    def get_success_url(self):
        msg = render_to_string(
            "eta/dashboard/shipping/messages/method_updated.html",
            {"method": self.object},
        )
        messages.success(self.request, msg, extra_tags="safe noicon")
        return reverse(
...
class WeightBandUpdateView(generic.UpdateView):
    model = WeightBand
    form_class = WeightBandForm
    template_name = "eta/dashboard/shipping/weight_band_form.html"
    ...
    def get_success_url(self):
        msg = render_to_string(
            "eta/dashboard/shipping/messages/band_updated.html", {"band": self.object}
        )
        messages.success(self.request, msg, extra_tags="safe noicon")
        return reverse(
            "dashboard:shipping-method-detail", kwargs={"pk": self.method.pk}
...
class WeightBandDeleteView(generic.DeleteView):
    model = WeightBased
    template_name = "eta/dashboard/shipping/weight_band_delete.html"
    context_object_name = "band"
    ...
    def get_success_url(self):
        msg = render_to_string(
            "eta/dashboard/shipping/messages/band_deleted.html", {"band": self.object}
        )
        messages.success(self.request, msg, extra_tags="safe noicon")
        return reverse(
            "dashboard:shipping-method-detail", kwargs={"pk": self.method.pk}
...
class WeightBasedDeleteView(generic.DeleteView):
    model = WeightBased
    template_name = "eta/dashboard/shipping/weight_based_delete.html"
    context_object_name = "method"

    def get_success_url(self):
        msg = render_to_string(
            "eta/dashboard/shipping/messages/method_deleted.html",
            {"method": self.object},
        )
        messages.success(self.request, msg, extra_tags="safe noicon")
