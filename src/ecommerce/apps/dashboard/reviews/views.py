...
class ReviewListView(BulkEditMixin, generic.ListView):
    model = ProductReview
    template_name = "eta/dashboard/reviews/review_list.html"
...
class ReviewUpdateView(generic.UpdateView):
    model = ProductReview
    template_name = "eta/dashboard/reviews/review_update.html"
...
class ReviewDeleteView(generic.DeleteView):
    model = ProductReview
    template_name = "eta/dashboard/reviews/review_delete.html"
    context_object_name = "review"
