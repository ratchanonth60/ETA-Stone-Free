...
from ecommerce.apps.order.models import Order, OrderNote, PaymentEvent, PaymentEventType
...
class TestOrderDetailPage(WebTestCase):
    ...
    def test_allows_line_status_to_be_changed(self):
        ...
        form["new_status"] = new_status = "Pending"
    ...
    def test_allows_order_status_to_be_changed(self):
        ...
        form = self.page.forms["order_status_form"]
        form["new_status"] = new_status = "Being processed"
        form.submit()
