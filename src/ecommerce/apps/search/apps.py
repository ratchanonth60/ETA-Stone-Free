...
class SearchConfig(OscarConfig):
    ...
    def ready(self):
        self.search_view = get_class(
            "search.views", "FacetedSearchView", "ecommerce.apps"
        )
        self.search_form = get_class("search.forms", "SearchForm", "ecommerce.apps")
    ...
    def get_sqs(self):
        ...
        """
        from ecommerce.apps.search import facets
