...
from django_tenants.utils import get_tenant_types, has_multi_type_tenants
...
class TenantSyncRouter(object):
    ...
    def app_in_list(self, app_label, apps_list):
        ...
        appconfig_full_name = f'{appconfig.__module__}.{appconfig.__class__.__name__}'
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        elif connection.schema_name == public_schema_name:
