...
from ecommerce.apps.catalogue.models import ProductClass, ProductImage
from ecommerce.apps.offer.models import Benefit, Condition, ConditionalOffer, Range
from ecommerce.apps.partner.models import Partner
from ecommerce.apps.shipping.models import WeightBand, WeightBased
from ecommerce.test.factories.address import *  # noqa
from ecommerce.test.factories.basket import *  # noqa
from ecommerce.test.factories.catalogue import *  # noqa
from ecommerce.test.factories.contrib import *  # noqa
from ecommerce.test.factories.customer import *  # noqa
from ecommerce.test.factories.offer import *  # noqa
from ecommerce.test.factories.order import *  # noqa
from ecommerce.test.factories.partner import *  # noqa
from ecommerce.test.factories.payment import *  # noqa
from ecommerce.test.factories.voucher import *  # noqa
from ecommerce.test.factories.wishlists import *  # noqa

Free = get_class("shipping.methods", "Free", "ecommerce.apps")
OrderCreator = get_class("order.utils", "OrderCreator", "ecommerce.apps")
