...
# Currency
OSCAR_DEFAULT_CURRENCY = "THB"
# set new currency format
OSCAR_CURRENCY_FORMAT = {"THB": {"format": "฿#,##0.00"}}
...
# Copy this image from eta/static/img to your MEDIA_ROOT folder.
...
OSCAR_FROM_EMAIL = "eta.support@gmail.com"
